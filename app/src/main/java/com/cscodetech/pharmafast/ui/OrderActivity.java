...
import com.cscodetech.pharmafast.model.OrderH;
import com.cscodetech.pharmafast.model.OrderHistory;
        ...
        try {
            ...
            if (callNo.equalsIgnoreCase("1")) {
                ...
                if (orderH.getResult().equalsIgnoreCase("true")) {
                    ...
                    txtNotFount.setText("Your orders will be displayed here.");
                }
